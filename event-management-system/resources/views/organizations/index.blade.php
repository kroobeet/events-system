<x-app-layout>
    <x-page-header title="Организации" />

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-2xl font-semibold mb-4">Список организаций</h1>
                    <div class="mb-4 flex justify-end">
                        <x-action-button route="{{ route('organizations.create') }}" label="Добавить организацию" color="gray" />
                    </div>
                    ...
                    <x-data-table :items="$organizations" :columns="[
                        ...
                        ['type' => 'form', 'route' => 'organizations.destroy', 'method' => 'DELETE', 'label' => 'Удалить', 'confirm' => 'Вы уверены, что хотите удалить эту организацию?', 'roles' => ['manager']]
                    ]"/>
                </div>
            </div>
        </div>
